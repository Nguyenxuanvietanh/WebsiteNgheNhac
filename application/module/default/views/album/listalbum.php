...
<div class="content">
    <div class="menu-left">
        <div class="data-list-title">
            <h1>
                <?php
                    $link = URL::createLink('default', 'album', 'index');
                    echo '<a href="'.$link.'">Album HOT</a>';
                ?>
            </h1>
        </div>
        <div class="data-list">
    ...
    <div class="list-content">
        ...
        <?php
            if(isset($this->arrParam['idtheloai'])){
                ...
                for($i = 0; $i < count($this->listAlbum); $i++){
                    echo '<h1 class="title-list">'.$this->quocgias[$i]['tenquocgia'].'</h1><hr>';
                    echo '<div  class= "row">';
                    
                    foreach($this->listAlbum[$i] as $album){
                        $link = URL::createLink('default', 'album', 'album', array('idalbum'=>$album['idalbum']));
                        echo '<div class="list-item col-3">
                                <a href="'.$link.'" title="">
                                    <img src="public/images/albums/'.$album['hinhanh'].'" alt="">
